 ...
 */
abstract class AbstractTargetDriverTestCase extends AbstractTestCase
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PHPFilesystemDriverTestFixture
     */
    private $subject;
    ...
    protected function setUp()
    {
        ...
        require_once str_replace(['/Unit/', 'TestCase.php'], ['/Fixtures/', 'TestCase.php'], __FILE__);
