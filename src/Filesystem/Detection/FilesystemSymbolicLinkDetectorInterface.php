 ...
 */
interface FilesystemSymbolicLinkDetectorInterface extends DetectorInterface
{
    /**
     ...
     * @var string
     */
    const DETECTION_FILENAME_PATTERN = '.symbolic-link-test-%s.txt';
     ...
     * @var string
     */
    const DETECTION_FOLDER_NAME = '.symbolic-link-detection';
}
